<template>
  <el-header id="header">
    ...
    <ul>
      <li style="margin-left: 250px" @click="$router.push('/')">首页</li>
      <li>大厅</li>
      <li>建议</li>
    ...
    <div v-if="state.loginstate" class="mine">
      ...
      ><router-link to="/mine" 
        ><el-dropdown class="router1">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item><router-link to="/mine" class="router1" style="line-height: 25px;"
        >个人空间</router-link
      ></el-dropdown-item>
              <el-dropdown-item @click="logout"><router-link to="/"  class="router1" style="line-height: 25px;">退出登录</router-link></el-dropdown-item>
            </el-dropdown-menu>
          </template>
  ...
  <el-body>
    ...
    <div v-if="isshow.showlogin" id="mask">
      <div id="login">
